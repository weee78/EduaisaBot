...
# =============================
# قائمة النصائح الصباحية (20 نصيحة)
# =============================
MORNING_TIPS = [
...
# =============================
# قائمة النصائح المسائية (20 نصيحة)
# =============================
AFTERNOON_TIPS = [
...
async def cmd_start(message: types.Message):
    ...
    print(f"📌 معرف المجموعة الخاصة في الكود: {OWNER_GROUP_ID}")
    if message.chat.id == OWNER_GROUP_ID:
        print("🎉 هذه هي المجموعة الخاصة! سيتم عرض الأزرار الإضافية.")
    else:
        print("⚠️ هذه المجموعة ليست الخاصة، سيتم عرض الأزرار الأساسية فقط.")
